...
const ENGINES: Engine[] = [
  { name: "ChatGPT", src: chatgptLogo.url, scale: 1.15, nudge: 0 },
  { name: "Claude", src: claudeLogo.url, scale: 1.1, nudge: 0 },
  { name: "Perplexity", src: perplexityLogo.url, scale: 0.95, nudge: 0 },
  { name: "Gemini", src: geminiLogo.url, scale: 1.0, nudge: 0 },
  { name: "Google", src: googleLogo.url, scale: 0.95, nudge: 0 },
];
